...
public class Tontraeger extends Medium
{
    ...
    public Tontraeger(int id, String titel, String autor, String isbn, String beschreibung, Genre genre, LocalDate erscheinungsdatum, String verlag, String sprache, int dauer, String sprecher)
    {
